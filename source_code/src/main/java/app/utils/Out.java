...
public class Out {
	...
	/**
	 * Initializes an output stream from a file with append option
	 * 
	 * @param filename the name of the file
	 * @param append append text to the file
	 */
	public Out(String filename, boolean append) {
		try {
	...
	/**
	 * Prints a long integer to this output stream and flushes this output
	 * stream.
	 * 
	 * @param x
	...
	/**
	 * Prints a formatted string to this output stream, using the specified
	 * locale, format string, and arguments, and then flushes this output
	 * stream.
	 *
	 * @param locale
	 *            the locale
